...
class TicketSales:
    def __init__(self, master):
        ...
        self.cell_entry_lable = Label(self.master, text='Enter CellNumber:', bg='#191923', fg='#BDBF09')
        self.cell_entry = Entry(self.master, bg='#BDBF09', fg='#191923')
        self.cell_entry_lable.place(x=10, y=10)
        self.cell_entry.place(x=200, y=10)

        # Ticket type label and option box for ticket type
        self.ticket_label = Label(self.master, text='Select Ticket Category:', bg='#191923', fg='#BDBF09')
        ...
        self.ticket_no_label = Label(self.master, text='Number of Tickets Bought:', bg='#191923', fg='#BDBF09')
        self.ticket_spinbox = Spinbox(self.master, width=10, from_=0, to=100, bg='#BDBF09', fg='#191923')
        ...
        # Payment info
        self.amount_pay = Label(self.frame, text='', fg='#191923', bg='#BDBF09')
        self.reserve = Label(self.frame, text='', fg='#191923', bg='#BDBF09')
        self.cell_label = Label(self.frame, text='', fg='#191923', bg='#BDBF09')
